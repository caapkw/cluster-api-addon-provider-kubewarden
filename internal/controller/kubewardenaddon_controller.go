...
// the KubewardenAddon object against the actual cluster state, and then
...
func (r *KubewardenAddonReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&addonv1alpha1.KubewardenAddon{}).
		Named("kubewardenaddon").
		Complete(r)
}
