...
var (
	...
	projectImage    = "ghcr.io/caapkw/caapkw-e2e"
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting cluster-api-addon-provider-kubewarden integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	cmd = exec.Command("make", "docker-build", fmt.Sprintf("CONTROLLER_IMG=%s", projectImage), fmt.Sprintf("TAG=%s", projectImageTag))
	_, err = utils.Run(cmd)
